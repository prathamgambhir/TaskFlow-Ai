  ...
  return (
    <section className="sticky top-0 z-50">
      <div className="w-full flex justify-center mb-4">
        <div className="grid grid-cols-2 md:grid-cols-3 border border-white/20 px-2 rounded-full h-16 w-7/8 lg:w-5/8 m-4 items-center mt-6 md:mt-8 backdrop-blur-lg shadow-sm">
