    ...
    <section className="dark:bg-black bg-white w-full py-28 md:py-40 lg:py-44 px-6 overflow-clip">
      ...
      >
        ...
        >
          ...
          >
            <Image src={EmojisterImage} alt="Imojister Image" />
          </motion.div>
          <motion.div
            style={{
              y: translateYParallax,
          ...
          >
            <Image src={HelixImage} alt="Helix Image" />
          </motion.div>
          ...
          <motion.h2
            variants={itemVariants}
            className="text-5xl md:text-6xl font-bold tracking-tight mb-8 dark:text-white text-slate-900"
          >
            Get instant access
          </motion.h2>
          ...
          <motion.p
            variants={itemVariants}
            className="dark:text-gray-400 text-slate-600 max-w-3xl text-lg md:text-xl leading-relaxed mb-10 mx-auto"
          >
          ...
          <motion.form
            variants={containerVariants}
            className="flex flex-col gap-3 w-full mx-auto max-w-3xl md:max-w-xl md:flex-row md:items-center"
          >
            <motion.input
              variants={itemVariants}
              type="email"
            ...
            <motion.button
              variants={itemVariants}
              type="submit"
              className="w-full lg:max-w-48 md:max-w-36 dark:bg-purple-700 bg-blue-500 text-white font-medium py-3 px-4 rounded-lg hover:bg-blue-600 dark:hover:bg-purple-800 transition-colors cursor-pointer"
            >
              Get access
            </motion.button>
          </motion.form>
